...
func init() {
	...
	groupDescAvailabilityProbeConfig := groupFields[36].Descriptor()
	...
	groupDescDataSharingEnabled := groupFields[38].Descriptor()
	...
	groupDescSessionIsolationEnabled := groupFields[39].Descriptor()
