...
default = "tokenrouter-grok"
web_search = "tokenrouter-grok"

[model."tokenrouter-grok"]
model = "grok-4.5"
base_url = "${baseUrl}"
name = "Grok 4.5 via TokenRouter"
description = "Grok 4.5 through a TokenRouter Grok group"
api_key = "${apiKey}"
...
function generateOpenCodeConfig(platform: string, baseUrl: string, apiKey: string, pathLabel?: string): FileConfig {
  ...
  if (platform === 'gemini') {
    ...
    provider[platform].name = 'Grok via TokenRouter'
