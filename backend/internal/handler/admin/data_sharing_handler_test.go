...
func TestDataShareCaptureRuntimeSettingsHandlers(t *testing.T) {
	...
	require.Equal(t, http.StatusOK, putRecorder.Code)
	require.JSONEq(t, `{"worker_count":3,"queue_size":8,"flush_queue_size":9,"task_timeout_seconds":60,"compression_level":"default","buffer_enabled":true,"buffer_idle_flush_seconds":7,"buffer_max_sessions":123,"buffer_max_pending_events":456,"duration_window_size":256,"export_batch_size":500}`, repo.values[service.SettingKeyDataSharingCaptureRuntime])
