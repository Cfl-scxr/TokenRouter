  ...
  admin: {
    ...
    tlsFingerprintRouters: {
      ...
      form: {
        ...
        chatgptOAuthTokenSettingsHint: 'Applies to OpenAI/ChatGPT OAuth accounts bound to this TLS router. Token User-Agent is also used by Codex invite reset and other ChatGPT backend requests.',
        chatgptOAuthTokenUserAgent: 'Token User-Agent',
        chatgptOAuthTokenUserAgentHint: 'For exchange/refresh token, an empty value falls back to the OpenAI Codex UA when token TLS profile is enabled. Codex invite reset falls back to the Codex Desktop UA.',
