  ...
  <div v-if="allEndpoints.length > 0" class="flex flex-wrap gap-2">
    ...
    >
      ...
      <div class="group/endpoint relative flex items-center gap-1.5">
        <div
          class="pointer-events-none absolute bottom-full left-1/2 z-20 mb-2 w-max max-w-[24rem] -translate-x-1/2 translate-y-1 rounded-xl border border-primary-900/10 bg-white px-3 py-2.5 text-left opacity-0 shadow-[0_14px_36px_-20px_rgba(0,0,0,0.32)] ring-1 ring-black/10 transition-all duration-150 group-hover/endpoint:translate-y-0 group-hover/endpoint:opacity-100 group-focus-within/endpoint:translate-y-0 group-focus-within/endpoint:opacity-100 dark:border-dark-600 dark:bg-dark-800 dark:ring-dark-600/70"
        >
          <p
