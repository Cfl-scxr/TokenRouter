...
marketplace: {
    ...
    routingHealthUpstreamAsset: 'Upstream quota / account rate',
    routingHealthUpstreamAssetHint: 'Balance and quota come from read-only upstream queries. The account rate comes from local billing settings. Upstream queries run at most once every 5 minutes.',
    ...
    routingHealthAccountMultiplier: 'Account rate {multiplier}',
