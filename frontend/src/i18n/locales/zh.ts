  ...
  admin: {
    ...
    tlsFingerprintRouters: {
      ...
      form: {
        ...
        chatgptOAuthTokenSettingsHint: '对绑定此 TLS 路由器的 OpenAI/ChatGPT OAuth 账号生效；Token User-Agent 也会用于 Codex 邀请重置等 ChatGPT 后台请求。',
        chatgptOAuthTokenUserAgent: 'Token User-Agent',
        chatgptOAuthTokenUserAgentHint: '留空时 exchange/refresh token 在启用 token TLS 模板后使用 OpenAI Codex UA 兜底；Codex 邀请重置请求使用 Codex Desktop UA 兜底。',
