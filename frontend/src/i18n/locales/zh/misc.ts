...
marketplace: {
    ...
    availabilityWindowHours: '近 {hours} 小时',
    availabilityNoData: '暂无数据',
    availabilityHint: '近 {hours} 小时主动探测可用率 {rate}（成功 {success} / 总计 {total}）',
    availabilityHintNoData: '近 {hours} 小时暂无主动探测数据',
    businessUsageTitle: '近 24 小时业务用量 · Token',
    businessUsageRequests: '请求数',
    businessUsageInput: '未缓存输入',
    businessUsageOutput: '输出',
    businessUsageCacheRead: '缓存读取',
    businessUsageCacheWrite: '缓存写入',
    businessUsageCacheRate: '缓存命中率',
    businessUsageCacheRateHint: 'Token 命中率 = 缓存读取 /（未缓存输入 + 缓存读取 + 缓存写入）。按业务日志已记录数据计算，不代表请求命中率。',
    businessUsageMissing: '未返回此项用量',
    businessUsageEmpty: '近 24 小时暂无业务调用',
    businessUsageError: '业务用量暂不可用',
    businessUsageStale: '刷新失败，显示上次业务用量',
    probeCurrentStatus: '当前状态',
    probeLastCheckedAt: '最后探测',
    probeStatusInterrupted: '中断',
    routingHealthRecentHit: '最近命中',
    routingHealthPreferred: 'Codex 首选',
    routingHealthLastSwitch: '最近成功换路',
    routingHealthSwitchWait: '等待新渠道首响应',
    routingSwitchReasons: {
      timeout: '上游超时', upstream_unavailable: '上游不可用', rate_limited: '上游限流',
      quota_exhausted: '额度耗尽', authentication_failed: '认证失败', health_priority_changed: '健康优先级变化',
      stream_interrupted: '输出中断', other: '上游异常',
    },
    probeCurrentLatency: '当前延迟',
    probeConsecutiveFailures: '连续失败',
    routingHealthUpstreamAsset: '上游余额 / 额度 / 折算倍率',
    routingHealthUpstreamAssetHint: '余额和额度来自上游只读查询；折算倍率 = 分组倍率 × 账号成本倍率。上游查询最多每 5 分钟执行一次。',
    routingHealthUpstreamBalance: '余额 {value}',
    routingHealthUpstreamQuotaPercent: '额度 {percent}% 可用',
    routingHealthUpstreamQuotaRemaining: '额度剩余 {value}',
    routingHealthUpstreamUnlimited: '额度 不限量',
    routingHealthEffectiveMultiplier: '折算倍率 {multiplier}',
    routingHealthMoreAccounts: '另有 {count} 个账号',
    probeStatusAvailable: '可调用',
    probeStatusSlow: '响应慢',
    probeStatusUnavailable: '异常',
    probeStatusUnknown: '尚未探测',
    probeStatusUnknownHint: '没有足够的有效探测样本，暂时无法判断好坏；这不等于故障。',
    probeNoData: '暂无',
    routingHealthTitle: '全渠道路由健康',
    routingHealthUpdatedAt: '数据更新',
    routingHealthCurrentHit: '当前任务最近命中：{supplier} / {model}',
    routingHealthNoCurrentHit: '当前还没有业务命中记录',
    routingHealthSourceUnavailable: '综合健康数据暂不可用，模型广场其他功能不受影响。',
    routingHealthAuthRequired: '管理员会话已失效，请重新登录后刷新页面。',
    routingHealthForbidden: '当前账号没有查看综合健康数据的管理员权限。',
    routingHealthNetworkError: '无法连接综合健康接口，请检查网络后重试。',
    routingHealthUnknownError: '综合健康接口请求失败，请刷新页面重试。',
    routingHealthChannel: '渠道 / 分组',
    routingHealthScore: '健康分',
    routingHealthScoreHint: '长期综合分，不等于最近一次探测结果：业务成功率 70 分 + 主动探测 20 分 + 延迟 10 分；单次失败或临时冷却不清零，累计故障才为 0 分，波动和恢复观察最高 79 分。',
    routingHealthScoreNoData: '暂无足够样本，暂不计算健康分。',
    routingHealthProbe24h: '近24小时探测',
    routingHealthBusinessSuccess: '业务成功率',
    routingHealthRouteState: '路由状态',
    routingHealthNextProbe: '下次恢复探测',
    routingHealthHealthy: '健康',
    routingHealthDegraded: '波动',
    routingHealthRecovering: '恢复观察',
    routingHealthUnavailable: '故障',
    routingHealthManualDisabled: '人工停用',
    routingHealthRouteAvailable: '已入池',
    routingHealthRouteCooldown: '冷却中',
    routingHealthRouteCooldownHint: '当前暂缓调度，系统会继续探测；这不等于累计故障，健康分不会因单次失败清零。',
    routingHealthRouteWarming: '热身中',
    routingHealthRouteWarmingHint: '渠道正在连续成功观察，达到恢复门槛后会重新进入稳定调度。',
    routingHealthRouteUnavailable: '已移出',
    routingHealthRouteUnavailableHint: '已达到连续失败或需要人工处理的门槛，当前不参与路由。',
    routingHealthNoBusinessSample: '暂无业务样本',
    routingHealthNoAutoReturn: '不自动回池',
    rateMultiplier: '分组倍率',
