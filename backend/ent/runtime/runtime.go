...
func init() {
	...
	groupDescAvailabilityProbeConfig := groupFields[42].Descriptor()
	...
	groupDescDataSharingEnabled := groupFields[44].Descriptor()
	...
	groupDescSessionIsolationEnabled := groupFields[45].Descriptor()
