...
// NamespacedToolName 记录 namespace 子工具的原始归属。
...
// 命中的调用会还原为 custom_tool_call；toolSearch 表示客户端声明了 tool_search，
// 对应代理调用会还原为 tool_search_call；namespaceTools 用于恢复子工具的原始
// namespace 与裸名称。
