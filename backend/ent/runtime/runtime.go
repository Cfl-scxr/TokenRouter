...
func init() {
	...
	groupDescAllowedClientProtocols := groupFields[45].Descriptor()
	...
	groupDescAvailabilityProbeConfig := groupFields[52].Descriptor()
	...
	groupDescDataSharingEnabled := groupFields[56].Descriptor()
	...
	groupDescSessionIsolationEnabled := groupFields[57].Descriptor()
