...
func init() {
	...
	groupDescAvailabilityProbeConfig := groupFields[44].Descriptor()
	...
	groupDescDataSharingEnabled := groupFields[48].Descriptor()
	...
	groupDescSessionIsolationEnabled := groupFields[49].Descriptor()
