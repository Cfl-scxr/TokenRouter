...
func TestParseAdminDataShareFiltersIncludesRequestPath(t *testing.T) {
	...
	c.Request = httptest.NewRequest(http.MethodGet, "/admin/data-sharing?request_path=/v1/responses&search=/v1&user_name=alice&api_key_name=主Key&group_name=共享分组", nil)
...
func TestAdminDataShareSessionToResponseIncludesRequestPath(t *testing.T) {
