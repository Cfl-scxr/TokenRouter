...
// API Keys
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: 'Configure Grok Build or OpenCode to send Responses API traffic through your TokenRouter Grok group.',
        ...
        note: 'Save the file as ~/.grok/config.toml, then run grok inspect and select tokenrouter-grok from /model.',
        noteWindows: 'Save the file as %USERPROFILE%\\.grok\\config.toml, then run grok inspect and select tokenrouter-grok from /model.',
      },
      opencode: {
