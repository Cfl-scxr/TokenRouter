...
marketplace: {
    ...
    availabilityWindowHours: 'Last {hours} hours',
    availabilityNoData: 'No data',
    availabilityHint: '{hours}-hour active probe availability {rate} ({success} success / {total} total)',
    availabilityHintNoData: 'No active probe data in the last {hours} hours',
    businessUsageTitle: 'Business usage · Last 24h · Tokens',
    businessUsageRequests: 'Requests',
    businessUsageInput: 'Uncached input',
    businessUsageOutput: 'Output',
    businessUsageCacheRead: 'Cache read',
    businessUsageCacheWrite: 'Cache write',
    businessUsageCacheRate: 'Cache hit rate',
    businessUsageCacheRateHint: 'Token hit rate = cache read / (uncached input + cache read + cache write), based on recorded business usage. This is not a request hit rate.',
    businessUsageMissing: 'Usage field not reported',
    businessUsageEmpty: 'No business calls in the last 24 hours',
    businessUsageError: 'Business usage unavailable',
    businessUsageStale: 'Refresh failed; showing previous business usage',
    ...
    routingHealthPreferred: 'Codex preferred',
    routingHealthLastSwitch: 'Latest successful failover',
    routingHealthSwitchWait: 'Wait for new upstream response',
    routingSwitchReasons: {
      timeout: 'Upstream timeout', upstream_unavailable: 'Upstream unavailable', rate_limited: 'Rate limited',
      quota_exhausted: 'Quota exhausted', authentication_failed: 'Authentication failed', health_priority_changed: 'Health priority changed',
      stream_interrupted: 'Stream interrupted', other: 'Upstream error',
    },
    probeCurrentLatency: 'Current latency',
    probeConsecutiveFailures: 'Consecutive failures',
    routingHealthUpstreamAsset: 'Upstream balance / quota / effective rate',
    routingHealthUpstreamAssetHint: 'Balance and quota come from read-only upstream queries. Effective rate = group rate x account cost rate. Upstream queries run at most once every 5 minutes.',
    routingHealthUpstreamBalance: 'Balance {value}',
    routingHealthUpstreamQuotaPercent: 'Quota {percent}% available',
    routingHealthUpstreamQuotaRemaining: 'Quota remaining {value}',
    routingHealthUpstreamUnlimited: 'Quota unlimited',
    routingHealthEffectiveMultiplier: 'Effective rate {multiplier}',
    routingHealthMoreAccounts: '{count} more accounts',
    probeStatusAvailable: 'Available',
    probeStatusSlow: 'Slow response',
    probeStatusUnavailable: 'Unavailable',
    probeStatusUnknown: 'Not probed yet',
    probeStatusUnknownHint: 'There are not enough valid probe samples to judge this channel yet; this does not mean it is failing.',
    probeNoData: 'No data',
    routingHealthTitle: 'All-channel routing health',
    routingHealthUpdatedAt: 'Updated',
    routingHealthCurrentHit: 'Latest task hit: {supplier} / {model}',
    routingHealthNoCurrentHit: 'No business request has been routed yet',
    routingHealthSourceUnavailable: 'Routing health data is temporarily unavailable. Other marketplace features are unaffected.',
    routingHealthAuthRequired: 'Your administrator session has expired. Sign in again and refresh the page.',
    routingHealthForbidden: 'This account does not have administrator permission to view routing health.',
    routingHealthNetworkError: 'The routing health endpoint is unreachable. Check the network and try again.',
    routingHealthUnknownError: 'The routing health request failed. Refresh the page and try again.',
    routingHealthChannel: 'Channel / Group',
    routingHealthScore: 'Health score',
    routingHealthScoreHint: 'Long-term composite score, not the latest probe result: business success 70 + active probe 20 + latency 10. One transient failure or cooldown does not reset it; accumulated failure is 0, while degraded and recovery states are capped at 79.',
    routingHealthScoreNoData: 'Not enough samples to calculate a score yet.',
    routingHealthProbe24h: '24h probes',
    routingHealthBusinessSuccess: 'Business success',
    routingHealthRouteState: 'Routing state',
    routingHealthNextProbe: 'Next recovery probe',
    routingHealthHealthy: 'Healthy',
    routingHealthDegraded: 'Degraded',
    routingHealthRecovering: 'Recovery watch',
    routingHealthUnavailable: 'Unavailable',
    routingHealthManualDisabled: 'Manually disabled',
    routingHealthRouteAvailable: 'In pool',
    routingHealthRouteCooldown: 'Cooling down',
    routingHealthRouteCooldownHint: 'Routing is temporarily paused while probes continue. This is not an accumulated failure and one failure does not reset the health score.',
    routingHealthRouteWarming: 'Warming up',
    routingHealthRouteWarmingHint: 'The channel is under consecutive-success observation and returns to stable routing after the recovery threshold is met.',
    routingHealthRouteUnavailable: 'Removed',
    routingHealthRouteUnavailableHint: 'The consecutive-failure or manual-attention threshold has been reached, so this channel is not currently routed.',
    routingHealthNoBusinessSample: 'No business sample',
    routingHealthNoAutoReturn: 'No automatic return',
