...
// Settings
    settings: {
      ...
      gatewayForwarding: {
        ...
        grokDefaultTextModelHint: 'Used for empty model values and, when enabled, requests from other client model namespaces. Custom Grok model IDs are accepted.',
        grokCrossClientMap: 'Map other clients to Grok',
        grokCrossClientMapHint: 'When enabled, GPT, Codex, o-series, and Claude model IDs are routed to the default Grok text model.',
